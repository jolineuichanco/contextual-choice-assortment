...
file_name = paste0("Instances3gamma0greatergammak/CC_parameters_", N.prods_name, "prod_", K.attributes, "attr.csv")
...
file_name.MNL = paste0("Instances3gamma0greatergammak/MNL_parameters_", N.prods_name, "prod_", K.attributes, "attr.csv")
...
CC_output_filename = paste0("Results3gamma0greatergammak/CC_OptPrices_", N.prods_name, "prod_", K.attributes, "attr.csv")
...
MNL_output_filename = paste0("Results3gamma0greatergammak/MNL_OptPrices_", N.prods_name, "prod_", K.attributes, "attr.csv")
