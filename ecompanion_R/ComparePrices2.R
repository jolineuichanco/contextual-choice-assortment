...
file_name = paste0("Instances2gamma0lessgammak/CC_parameters_", N.prods_name, "prod_", K.attributes, "attr.csv")
...
file_name.MNL = paste0("Instances2gamma0lessgammak/MNL_parameters_", N.prods_name, "prod_", K.attributes, "attr.csv")
...
CC_output_filename = paste0("Results2gamma0lessgammak/CC_OptPrices_", N.prods_name, "prod_", K.attributes, "attr.csv")
...
MNL_output_filename = paste0("Results2gamma0lessgammak/MNL_OptPrices_", N.prods_name, "prod_", K.attributes, "attr.csv")
